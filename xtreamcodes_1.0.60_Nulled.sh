...
cd /var/www/html
rm -rf 160.zip
wget http://yoda.dynns.com/v2/160.zip
sleep 1
unzip -o 160.zip
sleep 1
rm -rf whatismyip.php
wget http://yoda.dynns.com/v2/whatismyip.txt -O whatismyip.php
sleep 1
cd /tmp
sleep 1
rm -rf iptv_panel_pro.zip.ZIP
wget http://yoda.dynns.com/v2/iptv_panel_pro.zip.ZIP
sleep 1
cd /var/www/html/downloads/
sleep 1
rm -rf IPTV_PLATFORM.zip
wget http://yoda.dynns.com/v2/IPTV_PLATFORM.zip
sleep 1
cd /root
sleep 1
rm -rf install_iptv_pro.zip
wget http://yoda.dynns.com/v2/install_iptv_pro.zip
sleep 1
